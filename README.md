...
GLoader is a Web resources loader with dependency and fallback management. The library is very
lightweight (about 7 kb minified, 2 kb minified and gziped).
...
GLoader can load your resources both in parallel and sequencially, following a dependency graph
