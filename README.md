...
GLoader is a Web resources loader with dependency management. The library is very lightweight (6 kb minified).
...
It means for example that you should no longer worry to have errors such as "$ is undefined" when you use a library that depends on jQuery.
...
You can define a callback function when a resource has been loaded:
